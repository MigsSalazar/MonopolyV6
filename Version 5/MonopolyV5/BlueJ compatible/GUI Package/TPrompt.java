...
public class TPrompt extends JDialog {
	 ...
	 */
	public TPrompt(Runner gv, Player pl, Map<String, Player> players2, TradeManager tm){
	...
	public void formCenPanel(){
		...
		aList.addListSelectionListener(new ListSelectionListener(){
			public void valueChanged(ListSelectionEvent e){
				...
				String t="";
				int w = 0;
				if(a.equals("Get out of Jail Free Card")){
					t = "gojf";
					w=50;
				}else{
					t = "prop";
					Map<String,Property> props = currentP.getProps();
	...
	public void formBotPanel(){
		okButton.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){
				if( currentP != null && !currentA.equals("") ){
